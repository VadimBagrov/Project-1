    ...
    <div class="menu__div">
      ...
      <div class="menu__soc">
        <a class="menu__soc-l" href="#">
          <img class="menu__img" src="/app/images/dist/whatsapp.svg" alt="whatsapp">
        </a>
        <a class="menu__soc-l" href="#">
          <img class="menu__img" src="/app/images/dist/email.svg" alt="email">
        </a>
      </div>
      <p class="menu__number">+7 999 000-00-00</p>
      <img class="menu__logo" src="/app/images/src/logo-menu.png" alt="logo">
    </div>
  </section>
  <section class="politika container">
    <p class="politika__p">
    <h2 class="politika__h2">Политика в отношении обработки персональных
      данных</h2>
    </br>
    <h3 class="politika__h">1. Общие положения</h3></br>
    Настоящая политика обработки персональных данных составлена в соответствии
    с требованиями Федерального закона от 27.07.2006. No 152-ФЗ «О персональных
    ...
    персональных данных, предпринимаемые ООО"Миллениум" (далее — Оператор).
    ...
    может получить о посетителях веб-сайта https://zagorodstroy.pro.
    </br>
    <h3 class="politika__h">2. Основные понятия, используемые в Политике</h3></br>
    ...
    интернет по сетевому адресу https://zagorodstroy.pro.
    ...
    распространения).
    2.10. Пользователь — любой посетитель веб-сайта https://zagorodstroy.pro.
    ...
    <h3 class="politika__h">3. Основные права и обязанности Оператора</h3></br>
    ...
    <h3 class="politika__h">4. Основные права и обязанности субъектов персональных
      данных</h3></br>
    ...
    <h3 class="politika__h">5. Принципы обработки персональных данных</h3></br>
    ...
    <h3 class="politika__h">6. Цели обработки персональных данных</h3></br>
    ...
    <h3 class="politika__h">7. Условия обработки персональных данных</h3></br>
    ...
    <h3 class="politika__h">8. Порядок сбора, хранения, передачи и других видов обработки
      персональных данных</h3></br>
    ...
    Оператора info@zagorodstroy.pro с пометкой «Актуализация персональных
    данных».
    ...
    Оператора info@zagorodstroy.pro с пометкой «Отзыв согласия на обработку
    персональных данных».
    ...
    <h3 class="politika__h">9. Перечень действий, производимых Оператором с полученными
      персональными данными</h3></br>
    ...
    <h3 class="politika__h">10. Трансграничная передача персональных данных</h3></br>
    ...
    уведомление направляется отдельно от уведомления о намерении осуществлять
    ...
    <h3 class="politika__h">11. Конфиденциальность персональных данных</h3>
    ...
    <h3 class="politika__h">12. Заключительные положения</h3></br>
    ...
    к Оператору с помощью электронной почты info@zagorodstroy.pro.
    ...
    Интернет по адресу https://zagorodstroy.pro.
