...
$('.right__otk').click(function () {
  document.querySelector('.right__active').classList.add('right--activee');
  document.querySelector('.right__otk').classList.add('right--nonee');
});

$('.right__active-img').click(function () {
  document.querySelector('.right__active').classList.remove('right--activee');
  document.querySelector('.right__otk').classList.remove('right--nonee');
});
  ...
  function _22(io, el, _23, _24) {
    ...
    if (io) {
      ...
      new Animate(el, "opacity", {
        to: 1, time: _23, callback: function () {
          _24();
        }
      });
    } else {
      ...
      new Animate(el, "opacity", {
        to: 0, time: _23, callback: function () {
...
var simplebox = (function () {
  ...
  function _1e() {
    ...
    if (_e.transitionOut == "fade") {
      ...
      if (_e.transitionOut == "elastic") {
        ...
        _13 = t;
        new Animate(fx, "fx", {
          from: 0, to: 1, step: _3a, time: _e.speedOut, callback: function () {
  ...
  return {
    init: _20, start: function (el, _5b, now) {
      var _5c, _5d;
      if (typeof el === "string") {
